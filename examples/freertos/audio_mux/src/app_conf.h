...
#define appconfUSB_INTERRUPT_CORE               0 /* Must be kept off I/O cores. Best kept off core 0 with the tick ISR. */
#define appconfUSB_SOF_INTERRUPT_CORE           0 /* Must be kept off I/O cores. Best kept off cores with other ISRs. */
